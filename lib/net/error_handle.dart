...
class ExceptionHandle {
  ...
  static final Map<int, NetError> _errorMap = <int, NetError>{
    net_error: NetError(net_error, '当前没有网络, 请连接网络!'),
    parse_error: NetError(parse_error, '数据解析错误！'),
    socket_error: NetError(socket_error, '当前没有网络, 请连接网络!'),
    http_error: NetError(http_error, '服务器异常，请稍后重试！'),
    connect_timeout_error: NetError(connect_timeout_error, '当前没有网络, 请连接网络!'),
    send_timeout_error: NetError(send_timeout_error, '当前没有网络, 请连接网络!'),
    receive_timeout_error: NetError(receive_timeout_error, '当前没有网络, 请连接网络!'),
