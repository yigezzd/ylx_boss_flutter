...
/// 商品ABC分析页面
/// 参考 D:\VUE\ylx-boss\src\subs\data\businessReport\productABC\productABC.vue
class ProductAbcPage extends StatefulWidget {
  const ProductAbcPage({super.key});

  @override
  State<ProductAbcPage> createState() => _ProductAbcPageState();
}

class _ProductAbcPageState extends State<ProductAbcPage> with SingleTickerProviderStateMixin {
  ...
  static const _tabApis = [
    HttpApi.productabcGetAmtABC,
    HttpApi.productabcGetQtyABC,
    HttpApi.productabcGetGrossABC,
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('商品ABC分析', style: TextStyle(fontSize: 17)),
        centerTitle: true,
