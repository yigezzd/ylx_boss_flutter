...
class _CashFlowPageState extends State<CashFlowPage> {
  ...
  /// 格式化金额，保留指定小数位（同库存查询 _formatDecimal 逻辑）
  static String _formatAmount(int fractionDigits, dynamic value) {
  ...
  DataRow2 _buildDataRow(Map<String, dynamic> row, int index) {
    ...
    final amt = _formatAmount(2, row['amt']);
          ...
          GestureDetector(
            ...
            onTap: () {
              if (saleid.isNotEmpty) {
                NavigatorUtils.push(
                    context, '${CashFlowRouter.cashFlowBill}?saleid=$saleid&sid=$sid');
              }
            },
            child: Padding(
