...
/// 进货未销（无时间选择器，默认当月）
class EnterUnsoldPage extends StatefulWidget {
  const EnterUnsoldPage({super.key});
  @override
  State<EnterUnsoldPage> createState() => _EnterUnsoldPageState();
}

class _EnterUnsoldPageState extends State<EnterUnsoldPage> {
  ...
  String _sortField = 'notsaleday', _sortType = 'desc';
  static const _selecttype = 4;
  ...
  Map<String, dynamic> _baseParams() => {
        ...
        'showzerostockflag': _showzerostockflag,
        'saleflag': _saleflag,
        ...
        builder: (_) => InventoryFilterSheet(
            ...
            onConfirm: (data) {
              setState(() {
                ...
                _showzerostockflag = data.mpbilltypeflag;
                _saleflag = data.saleflag;
                _days = data.days;
              });
              _resetAndLoad();
            }));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
            title: const Text('进货未销', style: TextStyle(fontSize: 17)),
            centerTitle: true,
      ...
      child: RefreshIndicator(
        ...
        child: DataTable2(
          ...
          columns: [
            ...
            DataColumn2(
                fixedWidth: 150,
                label: _sortHeader('未销售持续天数', 'notsaleday'),
                onSort: (_, __) => _onSort('notsaleday',
                    _sortField == 'notsaleday' && _sortType == 'asc' ? 'desc' : 'asc')),
            const DataColumn2(
                fixedWidth: 110,
                label: Padding(
    ...
    return DataRow2(
      ...
      cells: [
        ...
        DataCell(Align(
            ...
            child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 8),
                child: Text(row['notsaleday']?.toString() ?? '', style: cs)))),
        DataCell(Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
